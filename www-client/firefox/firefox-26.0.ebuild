...
IUSE="bindist gstreamer +jit kde +minimal pgo pulseaudio selinux system-cairo system-icu system-jpeg system-sqlite oldbranding"
...
src_prepare() {
	...
	if use kde; then
		epatch "${FILESDIR}"/01-toolkit-download-folder.patch
		epatch "${FILESDIR}"/02-mozilla-nongnome-proxies.patch
		epatch "${FILESDIR}"/03-mozilla-prefer_plugin_pref.patch
		epatch "${FILESDIR}"/04-mozilla-kde.patch
		epatch "${FILESDIR}"/05-mozilla-preferences.patch
		epatch "${FILESDIR}"/06-mozilla-language.patch
		epatch "${FILESDIR}"/07-firefox-browser-css.patch
		epatch "${FILESDIR}"/08-firefox-kde.patch
		epatch "${FILESDIR}"/09-firefox-kde-114.patch
		epatch "${FILESDIR}"/10-firefox-no-default-ualocale.patch
		epatch "${FILESDIR}"/11-firefox-branded-icons.patch
	fi
